...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Akhilesh Singh</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Developer</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Immediate joiner. Looking for a better opportunity to switch to Non-It to IT sectorr as
						an entry-level developer with key skills Java,Possesses hands-on experience in Java,
						J2EE. Adept at Object-Oriented design principles, with exposure to Service Oriented
						Architecture (SOA) and XML-based applications.Familiarity with Microservices.I posses
						excellent communication skills and I enjoy learning new things.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Email - akhilesh1998singh@gmail.com</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Shakti nagar, Korba <br /> Chhattishgarh
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
